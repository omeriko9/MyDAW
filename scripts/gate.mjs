...
const SUITES = [
  ...
  { id: "rack-instrument", tier: "fast", script: "rack-instrument-test.mjs", requires: needsEngine,
    note: "SPEC §5.9 rack-owned VSTi: project-level instances, feeder routing, solo law, persistence" },
  ...
  { id: "midi-chase", tier: "fast", script: "midi-chase-test.mjs", requires: needsEngine,
    note: "starting playback INSIDE a held note must sound it (note chase), and only it" },
  ...
  { id: "stem-export", tier: "fast", script: "stem-export-test.mjs", requires: needsEngine,
    note: "SPEC §5.5 single-pass multi-sink: master must equal the sum of the stems" },
